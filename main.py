...
def schrift():
    global schriftfarbe
    schriftfarben = tkcolorpicker.askcolor(color=farbe, parent=fenster)
...
def hintergrund():
    global farbe
    farbe2 = tkcolorpicker.askcolor(color=farbe, parent=fenster)
    farbe = str(farbe2[1])
...
# Hash oder dehash
button_de_hash_1 = tk.Button(master=fenster, bg=buttfarbe, relief="groove", text="Hash", command="")
button_de_hash_1.place(x=310, y=620, width=220, height=60)
...
button_de_hash_2.place_forget()
# Hash oder Passwort
radiobutton_1_1 = tk.Radiobutton(master=fenster, bg=farbe, anchor="nw", text="Passwort eingabe", variable=passhex, value=1, command=passwort_hex)
radiobutton_1_1.config(font=("Arial", 12))
radiobutton_1_1.place(x=60, y=280, width=200, height=40)

radiobutton_1_2 = tk.Radiobutton(master=fenster, bg=farbe, anchor="nw", text="Hexadezimal eingabe", variable=passhex, value=2, command=passwort_hex)
...
entry_eingabefeld = tk.Entry(master=fenster, show="*", textvariable=entry_wert, relief="groove", bg=farbe)
entry_eingabefeld.place(x=60, y=60, width=700, height=220)

# Ausgabe
label_ausgabe = tk.Label(master=fenster, bg=farbe, relief="groove", anchor="nw", justify="left", textvariable=ausgabe)
...
# Wortliste auswählen
button_wortliste = tk.Button(master=fenster, bg="light gray", relief="groove", text="Wortliste auswählen", command=wortliste)
...
radiobutton_2_1 = tk.Radiobutton(master=fenster, bg=farbe, anchor="w", text="SHA 256", variable=hashalgowert, value="sha256")
radiobutton_2_1.config(font=("Arial", 12))
radiobutton_2_1.place(x=860, y=350, width=100, height=40)

radiobutton_2_2 = tk.Radiobutton(master=fenster, bg=farbe, anchor="w", text="SHA 512", variable=hashalgowert, value="sha512")
radiobutton_2_2.config(font=("Arial", 12))
radiobutton_2_2.place(x=1060, y=350, width=100, height=40)

radiobutton_2_3 = tk.Radiobutton(master=fenster, bg=farbe, anchor="w", text="MD5", variable=hashalgowert, value="md5")
radiobutton_2_3.config(font=("Arial", 12))
radiobutton_2_3.place(x=860, y=400, width=100, height=40)

radiobutton_2_4 = tk.Radiobutton(master=fenster, bg=farbe, anchor="w", text="SHA3 256", variable=hashalgowert, value="sha3")
